...
(function($) {
    ...
    var GmUtility = {
        ...
        addressByFormat: function(addresses, format) {
			//alert('Your current position is:'+addresses)
            var result = null;
			
            for (var i = addresses.length - 1; i >= 0; i--) {
                if (addresses[i].types.indexOf(format) >= 0) {
                    result = addresses[i];
					//alert('Your current position is:'+addresses[i]);
                }
            }
        ...
        updateLocationName: function(gmapContext, callback) {
            ...
            gmapContext.geodecoder.geocode({
                ...
                if (status == google.maps.GeocoderStatus.OK && results.length > 0) {
					...
					//alert('Your current position is:'+gmapContext.locationName );
					//gmapContext.locationName = address;
        ...
        address_component_from_google_geocode: function(address_components) {
            ...
            for (var i = address_components.length - 1; i >= 0; i--) {
				...
				//alert("inside addr comp" +component);
